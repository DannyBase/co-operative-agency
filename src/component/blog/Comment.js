            ...
            <div className="comment-list">
                <div className="comment">
                    <div className="thumbnail">
                        <img src={process.env.PUBLIC_URL + "/images/blog/author-1.jpg"} alt="Blog Comment" />
                    </div>
                ...
                <div className="comment comment-reply">
                    <div className="thumbnail">
                        <img src={process.env.PUBLIC_URL + "/images/blog/author-2.jpg"} alt="Blog Comment" />
                    </div>
                    <div className="content">
                        <div className="heading">
                ...
                <div className="comment">
                    <div className="thumbnail">
                        <img src={process.env.PUBLIC_URL + "/images/blog/author-3.jpg"} alt="Blog Comment" />
                    </div>
                    <div className="content">
                        <div className="heading">
                            <h5 className="title">Sophie Asveld</h5>
