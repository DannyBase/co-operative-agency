...
const ProcessOne = () => {
    return (
        ...
        <div className="section section-padding bg-color-light pb--70">
            <SectionTitle 
                subtitle="Process"
                title="Our Brand Identity Creation Process"
                description="Our comprehensive brand identity creation process ensures a complete and cohesive identity that accurately reflects your business and values."
                textAlignment=""
                textColor="mb--90"
            />
